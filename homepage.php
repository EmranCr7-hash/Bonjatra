    ...
    <!-- php end -->
        ...
        <header id="home">
            <div class="header-content">
                <h2 id="quote">Explore the Heart of Sundarbon</h2>
                <div class="line"></div>
                <h1>A WONDERFUL Forest</h1>
                <a
                    href="#about"
                    class="ctn"
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <article class="card col">
                        ...
                        <p class="font-color">
                           Discover the enchanting Sundarbans on a walking holiday through lush mangrove forests, vibrant wildlife habitats, and serene village paths. Experience local culture, spot rare species like the Bengal tiger, and explore tranquil riverbanks. 
                        </p>
                        <!-- <a href="#" class="ctn">All Details</a> -->
                    </article>
                    <article class="card col">
                        <img src="./img/img2.jfif" />
                        <h4 class="dark">Sundarbans</h4>
                        <p class="font-color">
                           A Sundarban tour offers a thrilling escape into the world’s largest mangrove forest, home to the elusive Royal Bengal Tiger. Cruise through winding rivers, explore dense mangroves, and witness unique wildlife. 
                        </p>
                        <!-- <a href="#" class="ctn">All Details</a> -->
                    </article>
                </div>
        ...
        <section class="tours" id="tours">
            <div class="container row">
                <div class="col content-col">
                    ...
                    <div class="line"></div>
                    <p>
                        Wed 28 July 2025 : Kotka beach (Sundarban)
                         <br />
                        Sat 1 Aug 2025 : Hiron Point<br />
                        Tues 4 Aug 2025 : South wild Experience.
                        <br />
                        and many more ......
                    </p>
                    ...
                    <span id="about-quad"
                        ><a href="#home"
                            ><center>
                                ...
                                <p>Welcome to BONJATRA—your travel companion!
                              We offer handpicked tours, local experiences,
                               and custom itineraries to make your journey unforgettable.
                             Book, explore, and enjoy hassle-free travel—all in one app.</p>
                            </center>
                        </a>
                    </span>
                </div>
...
<form class="cform" action="submit.php" method="post">
    ...
    <div class="crow">
        <div class="ccol-left">
            <textarea name="remarks" placeholder="Your Remarks....." required style="height: 150px"></textarea>
        </div>
    </div>
    <input class="crow-s" type="submit" value="Submit" />
        ...
        <section class="footer">
            <span
                >Created By Rafsan, Ehsan & Emran | &#169; 2025 All rights
                reserved.</span
            >
